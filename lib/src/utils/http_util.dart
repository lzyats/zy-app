...
import 'package:openim_enterprise_chat/src/models/error_info.dart';
  ...
  static Future post(String path,
    ...
    try {
      ...
      if (resp.errCode == 0) {
        ...
        if (check == true) {
          var errmsg = ErrorInfo.geterrstr(resp.errCode.toString());
          IMWidget.showToast(errmsg);
        } else {
      ...
      //print('--------resp1' + error.toString());
      if (error is DioError) {
        if (error.response == null) {
          IMWidget.showToast(StrRes.neterror);
        } else {
