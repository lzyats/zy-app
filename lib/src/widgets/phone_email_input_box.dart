...
class PhoneEmailInputBox extends StatelessWidget {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            height: 28.h,
            child: index == 0 ? _buildNameView() : _buildEmailView(),
          ),
          SizedBox(height: 6.h),
        ],
      ),
  ...
  Widget _buildNameView() => Row(
        crossAxisAlignment: CrossAxisAlignment.center,
        children: [
          Expanded(child: _textNameField()),
          _clearBtn(),
        ],
      );

  Widget _textNameField() => TextField(
  ...
  Widget _textinvitecodeField() => TextField(
        controller: phoneController,
        focusNode: phoneFocusNode,
        keyboardType: TextInputType.phone,
        textInputAction: TextInputAction.next,
