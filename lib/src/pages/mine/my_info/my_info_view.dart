        ...
        () => SingleChildScrollView(
          child: Column(
            children: [
              ...
              //   value:
              //       '${DateTime.fromMillisecondsSinceEpoch(imLogic.userInfo.value.birth!).toLocal().toString().substring(0, 10)}',
              ...
              _buildItemView(
                label: StrRes.usdt,
                value: imLogic.userInfo.value.exinfo!.usdt!
                    .toStringAsFixed(2)
                    .toString(),
                onTap: () => logic.tusdt(),
              ),
              _buildItemView(
                label: StrRes.udstaddr,
                onTap: () => logic.udstaddr(),
              ),
              _buildItemView(
                label: StrRes.myaddr,
                onTap: () => logic.myadd(),
              ),
              if (logic.isinvitecode! == '1')
                _buildItemView(
                  label: StrRes.mytg,
                  onTap: () => logic.mytg(),
                ),
