...
class ImageUtil {
  ...
  static Widget backn(Color color) => assetImage(
        'ic_back',
        width: 12.w,
        height: 20.h,
        color: color,
  ...
  static Widget toolsenvelope() => assetImage(
        'ic_tools_envelope_call',
        width: 48.h,
        height: 48.h,
      );
  ...
  static Widget envolopel() => assetImage(
        'ic_redl',
        width: 210.w,
        height: 78.h,
      );

  static Widget envoloper() => assetImage(
        'ic_redr',
        width: 210.w,
        height: 78.h,
      );
